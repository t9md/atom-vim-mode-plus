...
let CSON, path, selectList, getEditorStat, OperationAbortedError, __plus
const classRegistry = {}
...
function loadVmpOperationFile(filename) {
  ...
  const vmpLoadingFileOriginal = VMP_LOADING_FILE
...
class Base {
  ...
  onDidChangeSearch(...args) {
    return this.vimState.onDidChangeSearch(...args)
  }
  onDidConfirmSearch(...args) {
    return this.vimState.onDidConfirmSearch(...args)
  }
  onDidCancelSearch(...args) {
    return this.vimState.onDidCancelSearch(...args)
  }
  onDidCommandSearch(...args) {
    return this.vimState.onDidCommandSearch(...args)
  }
  onDidSetTarget(...args) {
    return this.vimState.onDidSetTarget(...args)
  }
  emitDidSetTarget(...args) {
    return this.vimState.emitDidSetTarget(...args)
  }
  onWillSelectTarget(...args) {
    return this.vimState.onWillSelectTarget(...args)
  }
  emitWillSelectTarget(...args) {
    return this.vimState.emitWillSelectTarget(...args)
  }
  onDidSelectTarget(...args) {
    return this.vimState.onDidSelectTarget(...args)
  }
  emitDidSelectTarget(...args) {
    return this.vimState.emitDidSelectTarget(...args)
  }
  onDidFailSelectTarget(...args) {
    return this.vimState.onDidFailSelectTarget(...args)
  }
  emitDidFailSelectTarget(...args) {
    return this.vimState.emitDidFailSelectTarget(...args)
  }
  onWillFinishMutation(...args) {
    return this.vimState.onWillFinishMutation(...args)
  }
  emitWillFinishMutation(...args) {
    return this.vimState.emitWillFinishMutation(...args)
  }
  onDidFinishMutation(...args) {
    return this.vimState.onDidFinishMutation(...args)
  }
  emitDidFinishMutation(...args) {
    return this.vimState.emitDidFinishMutation(...args)
  }
  onDidFinishOperation(...args) {
    return this.vimState.onDidFinishOperation(...args)
  }
  onDidResetOperationStack(...args) {
    return this.vimState.onDidResetOperationStack(...args)
  }
  onDidSetOperatorModifier(...args) {
    return this.vimState.onDidSetOperatorModifier(...args)
  }
  onWillActivateMode(...args) {
    return this.vimState.onWillActivateMode(...args)
  }
  onDidActivateMode(...args) {
    return this.vimState.onDidActivateMode(...args)
  }
  preemptWillDeactivateMode(...args) {
    return this.vimState.preemptWillDeactivateMode(...args)
  }
  onWillDeactivateMode(...args) {
    return this.vimState.onWillDeactivateMode(...args)
  }
  onDidDeactivateMode(...args) {
    return this.vimState.onDidDeactivateMode(...args)
  }
  onDidCancelSelectList(...args) {
    return this.vimState.onDidCancelSelectList(...args)
  }
  subscribe(...args) {
    return this.vimState.subscribe(...args)
  }
  isMode(...args) {
    return this.vimState.isMode(...args)
  }
  getBlockwiseSelections(...args) {
    return this.vimState.getBlockwiseSelections(...args)
  }
  getLastBlockwiseSelection(...args) {
    return this.vimState.getLastBlockwiseSelection(...args)
  }
  addToClassList(...args) {
    return this.vimState.addToClassList(...args)
  }
  getConfig(...args) {
  ...
  static generateCommandTableByEagerLoad() {
    ...
    const _ = _plus()
    const klasses = _.values(this.getClassRegistry())
    const klassesGroupedByFile = _.groupBy(klasses, klass => klass.VMP_LOADING_FILE)
  ...
  static getSpec() {
    if (this.isCommand()) {
      ...
      return {file: this.VMP_LOADING_FILE}
    }
  }

  static getClass(name) {
    const klass = classRegistry[name]
    if (klass) return klass

    const fileToLoad = this.commandTable[name].file
    if (!VMP_LOADED_FILES.includes(fileToLoad)) {
  ...
  static registerCommand() {
    ...
    return atom.commands.add(this.getCommandScope(), this.getCommandName(), function(event) {
      let left
      const vimState =
        (left = getEditorState(this.getModel())) != null ? left : getEditorState(atom.workspace.getActiveTextEditor())
      if (vimState != null) {
        // Possibly undefined See #85
  ...
  static registerCommandFromSpec(name, spec) {
    let {commandScope, commandPrefix, commandName, getClass} = spec
  ...
  static getKindForCommandName(command) {
    ...
    const _ = _plus()
    const name = _.capitalize(_.camelize(command))
