...
module.exports = class DemoModeSupport {
  constructor({onWillAddItem, onDidStart, onDidStop, onWillFadeoutHover, onDidRemoveHover}) {
    destroyAllDemoModeFlasheMarkers = this.destroyAllDemoModeFlasheMarkers.bind(this)
