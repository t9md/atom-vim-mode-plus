...
module.exports =
  ...
  registerVimStateCommands: ->
    ...
    commands =
      ...
      'operator-modifier-occurrence': -> @emitDidSetOperatorModifier(occurrence: true, occurrenceType: 'word')
      'operator-modifier-occurrence-for-subword': -> @emitDidSetOperatorModifier(occurrence: true, occurrenceType: 'subword')
