...
class AnyPair extends Pair {
  ...
  member = ['DoubleQuote', 'SingleQuote', 'BackTick', 'CurlyBracket', 'AngleBracket', 'SquareBracket', 'Parenthesis', 'InlineComment']
...
class InlineComment extends Pair {
  pair = ['/*', '*/']
}
...
module.exports = Object.assign(
  ...
  InlineComment.deriveClass(true),
