...
function normalizeIndent(text, editor, lastPastedRange) {
  ...
  const indentString = " ".repeat(detectMinimumIndentLengthInText(editor.getTextInBufferRange(lastPastedRange)))
