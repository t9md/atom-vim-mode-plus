...
module.exports = class VimState {
  ...
  getLastPastedRangesBySelection() {
    return this.pastedRangesBySelection || new Map()
  }

  getLastPastedRangeForSelection(selection) {
    return this.pastedRangesBySelection.get(selection)
  }

  setPasteCheckpoint(checkpoint) {
    this.pasteCheckpoint = checkpoint
  }

  getPasteCheckpoint() {
    return this.pasteCheckpoint
  }
}
