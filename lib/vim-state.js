  ...
  get modeManager() {
    ...
    if (!this.modeManagerStub) {
      this.modeManagerStub = {
        get onWillActivateMode() { return self.onWillActivateMode.bind(self) }, // prettier-ignore
        get onDidActivateMode() { return self.onDidActivateMode.bind(self) }, // prettier-ignore
        get onWillDeactivateMode() { return self.onWillDeactivateMode.bind(self) }, // prettier-ignore
        get preemptWillDeactivateMode() { return self.preemptWillDeactivateMode.bind(self) }, // prettier-ignore
        get onDidDeactivateMode() { return self.onDidDeactivateMode.bind(self) }, // prettier-ignore
      }
    }
