...
module.exports = class VimState {
  ...
  onDidSetOperatorModifier(fn) { return this.subscribe(this.emitter.on("did-set-operator-modifier", fn)) } // prettier-ignore
  emitDidSetOperatorModifier(options) { this.emitter.emit("did-set-operator-modifier", options) } // prettier-ignore
