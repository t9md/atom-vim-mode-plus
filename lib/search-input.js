...
module.exports = class SearchInput {
  ...
  focus(options = {}) {
    ...
    this.vimState.editorElement.classList.add("vim-mode-plus-search-input-focused")
  ...
  unfocus() {
    this.finished = true
    this.vimState.editorElement.classList.remove("vim-mode-plus-search-input-focused")
