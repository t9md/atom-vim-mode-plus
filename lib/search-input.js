...
module.exports = class SearchInput {
  ...
  constructor(vimState) {
    ...
    this.container.innerHTML = unindent`
  ...
  stopPropagation(oldCommands) {
    const newCommands = {}
    for (let [name, fn] of Object.entries(oldCommands)) {
  ...
  registerCommands() {
    return atom.commands.add(
      ...
      this.stopPropagation({
        ...
        "select-occurrence-from-search": () =>
          this.emitDidCommand("occurrence", {operation: "SelectOccurrence"}),
        "change-occurrence-from-search": () =>
          this.emitDidCommand("occurrence", {operation: "ChangeOccurrence"}),
