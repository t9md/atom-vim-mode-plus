...
module.exports = {
  ...
  registerEditorCommands() {
    ...
    const dispatcher = function(event) {
      ...
      if (vimState) vimState.operationStack.run(classify(event.type.replace("vim-mode-plus:", "")))
    }
  ...
  get demoModeSupport() {
    return this.__demoModeSupport || (this.__demoModeSupport = require("./demo-mode-support"))
  },
  get paneUtils() {
    ...
    return {
      Base: {
        get getClass() {
          ...
          return (...args) => getBoundBaseMethod("getClass")(...args)
        },
      },
      get registerCommandFromSpec() {
        return (...args) => getBoundBaseMethod("registerCommandFromSpec")(...args)
      },
      get getClass() {
        return (...args) => getBoundBaseMethod("getClass")(...args)
      },
