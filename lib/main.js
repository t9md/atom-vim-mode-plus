...
module.exports = {
  ...
  activate() {
    ...
    this.subscriptions.add(...Base.init(getEditorState))
    ...
    if (atom.inDevMode()) {
      ...
      this.subscriptions.add(this.developer.init(getEditorState))
    }
  ...
  registerVimStateCommands() {
    ...
    this.subscriptions.add(atom.commands.add("atom-text-editor:not([mini])", bindToVimState(commands)))
  },
