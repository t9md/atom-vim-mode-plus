...
class PascalCase extends TransformString {
  ...
  getNewText(text) {
    return this._.capitalize(this._.camelize(text))
  }
}
...
class TitleCase extends TransformString {
  ...
  getNewText(text) {
    return this._.humanizeEventName(this._.dasherize(text))
  }
}
