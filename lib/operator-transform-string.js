...
class AlignStartOfOccurrence extends TransformString {
  occurrence = true
  which = "start"
  ...
  getNewText(text, selection) {
    ...
    return this.which === "start" ? padding + text : text + padding
  }
}
AlignStartOfOccurrence.register()

class AlignEndOfOccurrence extends AlignStartOfOccurrence {
  which = "end"
}
...
const classesToRegisterToSelectList = [
  ...
  AlignStartOfOccurrence, AlignEndOfOccurrence,
