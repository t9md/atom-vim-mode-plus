...
module.exports = new Settings("vim-mode-plus", {
  ...
  keymapIAndAToInsertAtTargetWhenHasOccurrence: {
    title: "keymap `I` and `A` to `insert-at-start-of-target` and `insert-at-end-of-target` when editor has `preset-occurrence` marker.",
    default: false,
    description:
      "Can: `I p`, `A p` to insert at start or end of `preset-occurrence` in paragraph(`p`).<br>`I` and `A` is operator which take target, you can combine it with any target like `I f`(`a-function`), `A z`(`a-fold`).<br>Conflicts: You cannot use normal `I` and `A` when `preset-occurrence` marker is exists.",
  },
